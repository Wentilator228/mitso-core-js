...
function getCardId(value) {
  ...
  const suitSymbol = value[value.length - 1];
  const rankSymbol = value.substring(0, value.length - 1);
  const suitIndex = suits.indexOf(suitSymbol);
  const rankIndex = ranks.indexOf(rankSymbol);
